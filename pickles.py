...
## welcome to PICKLES --> Pipeline for Identification of Clusters using Kurtosis for Localizing Extraterrestrial Signals.
        ...
        try:
            ...
            for i in batch_observations_to_run_on:
                ...
                try:
                    ...
                    # grab all observations but last one in case that one hadn't finished fully
#                     try:
#                         batches_already_run = [eval(x)[1] for x in list(last_mason['Batch Info'])][:-1]
#                     except:
#                         print("first run with this csv")
#                         batches_already_run = []
#                     print('batches alread ran:', set(batches_already_run))
